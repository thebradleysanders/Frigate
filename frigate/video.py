...
class FrameTracker(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            while len([r for r in self.motion_regions if r.is_set()]) > 0: #remove line to ignore motion
            ...
            # wait for the global motion flag to change, remove code block to ignore motion
